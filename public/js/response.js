function getBotResponse(input) {
  switch (input.toLowerCase()) {
    ...
    case "what are signs of poor mental health?":
      return "-Excessive Paranoia, worry, or anxiety<br>-Long lasting sadness or irritablity<br>-Extreme changes in moods<br>Social withdrawal<br>-Dramatic changes in eating or sleeping pattern.";
